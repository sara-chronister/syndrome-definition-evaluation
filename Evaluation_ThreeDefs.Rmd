...
information_table <- read.xlsx("DefinitionInformationTable.xlsx", sheet = "DefinitionInformation", rows = c(2:5), cols = c(1:7))
...
write.csv(file = paste0("Output_ThreeDefs/",def1_short, " and ",def2_short," and ",def3_short," Visits.csv"),
