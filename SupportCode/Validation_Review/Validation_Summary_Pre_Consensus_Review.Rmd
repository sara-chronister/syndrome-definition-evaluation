...
if(length(ReviewScale) == 2){ # TP, FP
  ...
  query_performance_template <- c(
    ...
    "caret::confusionMatrix(data=list_reviewer_cm[[{{i}}]]$Definition, reference = list_reviewer_cm[[{{i}}]]$Review_Category)", # Print confusion matrix
